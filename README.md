...
### 4 - **rescale_rasters**
Rescales ANUClimate 2.0 Gridded data to match the resolution of AGCD and SILO gridded data, if they are to be used simultaneously. 
...
Rescale ANUClim rasters to match SILO and AGCD
**NOTE:** only necessary if using ANUClim and SILO/AGCD data alongside one another)
