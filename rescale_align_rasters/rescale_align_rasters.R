...
rescale_align_rasters <- function(var_directories,
                                   template_file) {
...
# rescale_align_rasters(var_directories = c("github/clim_data/t_min", "github/clim_data/t_max", 'github/clim_data/rain'),
